...
const teamMembers = [
    {
        ...
        role: "Dentist", 
        description: `
            Dr. Thayne Dawson grew up in a big family in Idaho. 
            ...
            Becoming a dentist wasn’t something that Dr. Dawson never saw himself doing, 
            ...
            DMD degree at the Medical University of South Carolina and then moved his family back across  
            ...
            `.trim()
             .replace(/\n{2,}/g, '</p><p>') // blank lines -> new paragraph
    ...
    },
    {
        ...
        description: `Jessica is more than just a receptionist. Whether you need to schedule an appointment, pay a bill or have questions about your insurance, she will take the time to help with all your needs.
            Jessica was born and raised in Wenatchee, WA, which is known for being the apple capital of the world. 
            
            She grew up always playing outside and climbing the tall pine trees.
            The Oregon coast was one of her favorite places to explore until she discovered Alaska and moved here in 2020 with her husband. They are living life to the fullest and checking off their bucket-list, 
            climbing glaciers and discovering the beauty of Alaska.`
            .trim()
             .replace(/\n{2,}/g, '</p><p>') // blank lines -> new paragraph
             .replace(/\s*\n\s*/g, ' ') // single newline -> space
             .replace(/^/, '<p>') // wrap start
    ...
    },
    {
        ...
        description: `Alyssa was born in Minnesota and raised in Wasilla, Alaska. 
        She graduated from the University of Alaska Anchorage. When she isn’t cleaning teeth, 
        she enjoys spending time with her husband and dogs, gardening, and traveling. `
        .trim()
             .replace(/\n{2,}/g, '</p><p>') // blank lines -> new paragraph
             .replace(/\s*\n\s*/g, ' ') // single newline -> space
             .replace(/^/, '<p>') // wrap start
    ...
    },
    {
        ...
        name: "Shania", 
        role: "Dental Assistant",
        description: `Shania has been a dental assistant for about 3 years in Hawaii and Alaska! 
        Shania was born and raised in Alaska between Fairbanks and Wasilla. 
        She loves traveling with her family and sitting on a warm beach with a poke bowl. 
        She enjoys getting to know patients of all ages and can’t wait to see you all in our office!`
        .trim()
             .replace(/\n{2,}/g, '</p><p>') // blank lines -> new paragraph
             .replace(/\s*\n\s*/g, ' ') // single newline -> space
             .replace(/^/, '<p>') // wrap start
