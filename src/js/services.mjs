...
const services = [
    {
        ...
        img: "/images/img-links/preventative.webp",
    ...
    },
    {
        ...
        img: "/images/img-links/implants.webp",
    ...
    },
    {
        ...
        name: "Emergency Care",
        img: "/images/img-links/emergency.webp",
    ...
    },
    {
        ...
        img: "/images/img-links/cosmetic.webp",
...
const procedures = {
    "comprehensive-exams": {
        ...
        img: "/images/prev-care/exams.webp", 
    ...
    "professional-cleanings": {
        ...
        img: "/images/prev-care/cleanings.webp", 
    ...
    "fluoride-treatments": {
        ...
        img: "/images/prev-care/fluoride.webp",
    ...
    "dental-sealants": {
        ...
        img: "/images/prev-care/sealant.webp", 
    ...
    "oral-cancer-screenings": {
        ...
        img: "/images/prev-care/cancer.webp", 
    ...
    "x-rays": {
        title: "X-rays", 
        img: "/images/prev-care/xray.webp", 
    ...
    "fillings": {
        title: "Fillings", 
        img: "/images/rest-care/filling.webp", 
    ...
    "same-day-crowns": {
        ...
        img: "/images/rest-care/crown.webp",
    ...
    "bridges": {
        title: "Bridges", 
        img: "/images/rest-care/bridge.webp",
    ...
    "implants": {
        title: "Implants",
        img: "/images/rest-care/implant.webp", 
    ...
    "toothaches": {
        title: "Toothaches", 
        img: "/images/emerg-care/toothache.webp",
    ...
    "chipped-or-broken-teeth": {
        ...
        img: "/images/emerg-care/chipped.webp", 
    ...
    "lost-fillings-or-crowns": {
        ...
        img: "/images/emerg-care/lost-filling.webp",
    ...
    "abscesses": {
        title: "Abscesses", 
        img: "/images/emerg-care/abscess.webp",
    ...
    "oral-trauma": {
        title: "Oral Trauma", 
        img: "/images/emerg-care/trauma.webp", 
    ...
    "root-canals": {
        title: "Root Canals", 
        img: "/images/emerg-care/rCanal.webp",
    ...
    "extractions": {
        title: "Extractions", 
        img: "/images/emerg-care/extraction.webp",
    ...
    "partial-dentures": {
        ...
        img: "/images/removable/partial.webp",
    ...
    "implant-supported-dentures": {
        ...
        img: "/images/removable/iDenture.webp",
    ...
    "flippers": {
        title: "Flippers",
        img: "/images/removable/flipper.webp", 
    ...
    "teeth-whitening": {
        ...
        img: "/images/cosmetic/whitening.webp",
    ...
    "veneers": {
        title: "Veneers", 
        img: "/images/cosmetic/veneer.webp",
    ...
    <ul id="services-offered-list">
        <li>
            <div 
                ...
                >
                <img src="/images/img-links/preventative.webp" 
        ...
        <li>
            <div 
                ...
                >
                <img 
                    src="/images/img-links/implants.webp" 
                    alt="Image of a dental implant bridge" 
                    id="restorative" 
                    class="service-icon"
                    >
        ...
        <li>
            <div 
                ...
                >
                <img 
                    src="/images/img-links/emergency.webp" 
        ...
        <li>
            <div 
                ...
                >
                <img 
                    src="/images/img-links/cosmetic.webp" 
...
function buildProcedureModal(procedureId) {
    ...
    const hasList = Array.isArray(p.list) && p.list.length > 0;

    const lead = p.paragraph || "";
    ...
    return `
        ...
        ${
            ...
            : (hasList ? `<ul>${p.list.map(item => `<li>${item}</li>`).join("")}</ul>` : "")
        }
    `;
}
...
services.forEach(service => {
    document.body.insertAdjacentHTML("beforeend", `
        <div id="${service.id}" class="modal hidden"
...
document.addEventListener("click", (event) => {
    ...
    const pdfClick = event.target.closest('a[href*="/pdf-forms/"]');
    if (pdfClick) {
        return;
    }
    // only handle procedure buttons
